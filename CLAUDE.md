...
This project is indexed by GitNexus as **kclub-v4** (2962 symbols, 6299 relationships, 228 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
