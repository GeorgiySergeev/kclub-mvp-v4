...
This project is indexed by GitNexus as **kclub-v4** (2298 symbols, 4694 relationships, 179 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
