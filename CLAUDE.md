...
This project is indexed by GitNexus as **kclub-v4** (1747 symbols, 2780 relationships, 102 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
