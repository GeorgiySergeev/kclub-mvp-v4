...
This project is indexed by GitNexus as **kclub-v4** (3714 symbols, 8540 relationships, 286 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
