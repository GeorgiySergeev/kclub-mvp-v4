...
This project is indexed by GitNexus as **kclub-v4** (2558 symbols, 5421 relationships, 196 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
