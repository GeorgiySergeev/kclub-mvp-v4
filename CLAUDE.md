...
This project is indexed by GitNexus as **kclub-v4** (3676 symbols, 8485 relationships, 283 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
