  ...
  return (
    <section className="border-b kclub-border bg-[#f4f4f2] py-16 dark:bg-[#111113] sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10">
        ...
        <div className="mt-12 grid gap-px border kclub-border-strong bg-zinc-300 dark:bg-white/10 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((item, index) => {
            ...
            return (
              ...
              >
                <div className="flex h-12 w-12 items-center justify-center border kclub-border text-[#ff0030] transition group-hover:border-white/20 group-hover:text-white">
                ...
                <p className="mt-4 text-sm font-medium leading-7 text-zinc-600 transition group-hover:text-white/72 dark:text-white/70">
                  {item.description}
                </p>
              </article>
            );
