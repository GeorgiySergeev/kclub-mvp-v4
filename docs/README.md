...
| [`DESIGN-SYSTEM.md`](DESIGN-SYSTEM.md)           | **Mandatory pre-coding read.** Color palette, typography, components, layout, icon rules         |
...
- `DESIGN-SYSTEM.md` wins on all visual design, component usage, and UI pattern decisions.
