...
This project is indexed by GitNexus as **kclub-v4** (2662 symbols, 5619 relationships, 203 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
