...
This project is indexed by GitNexus as **kclub-v4** (4026 symbols, 9287 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
