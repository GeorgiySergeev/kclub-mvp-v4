...
This project is indexed by GitNexus as **kclub-v4** (1382 symbols, 1739 relationships, 37 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
