...
This project is indexed by GitNexus as **kclub-v4** (1384 symbols, 1742 relationships, 37 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
